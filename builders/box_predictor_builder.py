...
def build(argscope_fn, box_predictor_config, is_training, num_classes,
  ...
  if  box_predictor_oneof == 'convolutional_box_predictor':
    ...
    return build_convolutional_box_predictor(
        ...
        mask_use_dropout=config_box_predictor.mask_use_dropout,
        mask_dropout_keep_prob=config_box_predictor.mask_dropout_keep_probability,
        mask_kernel_size=config_box_predictor.mask_kernel_size,
